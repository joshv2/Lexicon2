...
class DefinitionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'definition' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null],
        '_indexes' => [
            'word_id' => ['type' => 'index', 'columns' => ['word_id'], 'length' => []],
            'definition' => ['type' => 'fulltext', 'columns' => ['definition'], 'length' => []],
        ],
        '_constraints' => [
