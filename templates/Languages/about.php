...
<div id="notes" class="c content">
	<?php if (!empty($sitelang->AboutSec1Text)): ?>
...
<?php if (!empty($sitelang->AboutSec2Header)): ?>	
	<div class="page-header group">
