...
?>
	...
	<div class='c'>
		<div class="word">
			...
			<?php
				$canManageSentences = $this->Identity->isLoggedIn()
					&& in_array($this->request->getSession()->read('Auth.role'), ['superuser', 'moderator'], true);
			?>
			<?php if (!empty($sentences) || $canManageSentences): ?>
