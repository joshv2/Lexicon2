...
<?php echo $this->Html->image('header3.jpg', ['height' => 200, 'width' => 900])?>
    ...
    <div id="home2" class="c">
		...
		<p id="first_time_here"><?=__("First time here? Read our ")?><?php echo $this->Html->link('welcome', '/about');?><?=__("page")?></a>.</p>
		
		<p class="m3 center"><?=__("The lexicon currently has ")?><?=$this->Html->link($total_entries, '/words');?> <?=__("entries, including ")?><br /><?=$this->Html->link($no_dict_entries, '/words?dictionary=none');?> <?=__("entries that do not appear in any Jewish English dictionary.")?></p>
		<hr class="m2" />
		...
		<p class="m2">(See the <?php echo $this->Html->link('NOTES', '/notes');?> <?=__("for information about these languages, dictionaries, and types of people.")?>)</p>
